...
func (k *KamarRepositoryImpl) Delete(ctx context.Context, tx *sql.Tx, kamar domain.Kamar) domain.Kamar {
	panic("unimplemented")
}

// FindAll implements KamarRepository.
func (k *KamarRepositoryImpl) FindAll(ctx context.Context, tx *sql.Tx) []domain.Kamar {
	panic("unimplemented")
}

// FindById implements KamarRepository.
func (k *KamarRepositoryImpl) FindById(ctx context.Context, tx *sql.Tx, kamar domain.Kamar) domain.Kamar {
	panic("unimplemented")
}

// Save implements KamarRepository.
func (k *KamarRepositoryImpl) Save(ctx context.Context, tx *sql.Tx, kamar domain.Kamar) domain.Kamar {
...
func (k *KamarRepositoryImpl) Update(ctx context.Context, tx *sql.Tx, kamar domain.Kamar) domain.Kamar {
